...
static INT32 char2uni(CONST UINT8 *rawstring, UINT32 boundlen, UINT16 *uni)
{
...
UINT32 ML_InitISO8859_14(void)
{
    return ML_RegisterTable(&table);
}

VOID ML_ExitISO8859_14(void)
{
