...
#define rda_log2file1(format, ...)	cg_log_print(SEV_DEBUG_L6, __FILE__, __LINE__, __FUNCTION__, format, __VA_ARGS__)
#define rda_log2file2(format, ...)	cg_log_print(SEV_DEBUG_L7, __FILE__, __LINE__, __FUNCTION__, format, __VA_ARGS__)
#define rda_log2file3(format, ...)	cg_log_print(SEV_DEBUG_L8, __FILE__, __LINE__, __FUNCTION__, format, __VA_ARGS__)
#define rda_log2file4(format, ...)	cg_log_print(SEV_DEBUG_L9, __FILE__, __LINE__, __FUNCTION__, format, __VA_ARGS__)
