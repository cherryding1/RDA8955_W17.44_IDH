...
{
	cg_log_debug_l4("Entering...cg_http_response_clear\n");
	...
	cg_log_debug_l4("Leaving...cg_http_response_clear\n");
}
...
BOOL cg_http_response_read(CgHttpResponse *httpRes, CgSocket *sock, BOOL onlyHeader)
{
	...
	cg_log_info("Entering...cg_http_response_read\n");
	...
	cg_log_debug_l4("Leaving...cg_http_response_read\n");

    cg_log_info("Leaving...cg_http_response_read\n");
...
{
	cg_log_debug_l4("Entering...cg_http_response_print\n");
	
	cg_log_debug_l4("%s %d %s\n",
	...
	cg_log_debug_l4("Leaving...cg_http_response_print\n");
}
