...
#if defined(__rda_dmr__)
/* UPnP-av-ContentDirectory-v1-Service */
/* 5.1.1.1. ProtocolInfo definition */
{
	CgUpnpAvProtocolInfo *info=cg_upnpav_protocolinfo_new();
	cg_upnpav_protocolinfo_setprotocol(info, "http-get");
	cg_upnpav_protocolinfo_setnetwork(info, "*");
	cg_upnpav_protocolinfo_setmimetype(info, "audio/mpeg");
	cg_upnpav_protocolinfo_setadditionainfo(info, "*");
	cg_upnpav_dmr_addprotocolinfo(dmr,info);
}
{
	CgUpnpAvProtocolInfo *info=cg_upnpav_protocolinfo_new();
	cg_upnpav_protocolinfo_setprotocol(info, "http-get");
	cg_upnpav_protocolinfo_setnetwork(info, "*");
	cg_upnpav_protocolinfo_setmimetype(info, "audio/aac");
	cg_upnpav_protocolinfo_setadditionainfo(info, "*");
	cg_upnpav_dmr_addprotocolinfo(dmr,info);
}
#endif
...
void cg_upnpav_dmr_delete(CgUpnpAvRenderer *dmr)
{
	...
	{
#if defined(__rda_dmr__)	
		cg_upnpav_protocolinfolist_clear(dmr->protocolInfoList);
#endif
