...
void cg_upnp_device_announce(CgUpnpDevice *dev)
{
	...
	ssdpCount = 3; //cg_upnp_ssdp_getannouncecount();	
...
#if defined(__rda_debug_log__) && defined(__rda_cust_postsearchresponse_debug__)
	rdadebug_log_cg_upnp_device_postsearchresponse(ssdpPkt,ssdpRes);
#endif	
...
BOOL cg_upnp_device_start(CgUpnpDevice *dev)
{
	...
	hal_HstSendEvent(SYS_EVENT, 0x08070081);
	...
	dev->ssdpSock = cg_upnp_ssdp_socket_new();
	
	//dev->ssdpClientSock = cg_upnp_ssdp_socket_new();
	/**** Announce ****/
