...
#if defined(__rda_debug_log__) && defined(__rda_cust_ssdpmessagereceived_debug__)
...
#if defined(__rda_debug_log__) && defined(__rda_cust_ssdpmessagereceived_debug__)
		rdadebug_log_cg_upnp_device_ssdpmessagereceived(ssdpPkt);		
#endif
...
#if __rda_cust_dmr_debug__
	printf("cg_upnp_device_ssdpmessagereceived>>>>>>>>>>cg_upnp_device_postsearchresponse\n\n");
#endif
