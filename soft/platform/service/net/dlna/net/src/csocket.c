...
#if !defined(WINCE) && !defined(RDA_DLNA)
#include <errno.h>
#endif
...
#if (!defined(WIN32) || defined(__CYGWIN__)) && !defined(BTRON) && !defined(ITRON) && !defined(TENGINE) && !defined(RDA_DLNA)
...
#if defined(WIN32) || defined(HAVE_IP_PKTINFO) || defined(RDA_DLNA)
...
#if defined(BTRON) || (defined(TENGINE) && !defined(CG_TENGINE_NET_KASAGO)) || defined(RDA_DLNA)
	netif_get_adapterInfo(name, localAddr);
