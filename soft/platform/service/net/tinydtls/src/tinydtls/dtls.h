...
typedef struct __attribute__((__packed__)) {
    ...
    uint8 epoch[2];            /**< counter for cipher state changes */
    uint8 sequence_number[6];  /**< sequence number */
    uint8 length[2];           /**< length of the following fragment */
  /* fragment */
...
typedef struct __attribute__((__packed__)) {
    ...
    uint8 length[3];          /**< length of this message */
    uint8 message_seq[2];     /**< Message sequence number */
    uint8 fragment_offset[3]; /**< Fragment offset. */
    uint8 fragment_length[3]; /**< Fragment length. */
  /* body */
