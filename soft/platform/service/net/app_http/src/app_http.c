...
{
    return jdi_WPHTTPInitialize(*pucServer,
                         uhPort,
                         vMemHandle,
                         uiConnID,
                         iMaxSockets,
...
{
    jdi_WPHTTPSetSecurePortNumber(*vHttpHandle,
                                  uhSecurePort);
}
...
{
    return jdi_WPHTTPCreateTransaction(vHttpHandle,
                                *pstHttpRequest);
}
...
JC_RETCODE app_WPHTTPDeleteTransaction (JC_HANDLE   vHttpHandle,
                                        JC_UINT32   uiReqId)
{
    return jdi_WPHTTPDeleteTransaction(vHttpHandle,
                                uiReqId);
}
...
JC_RETCODE app_WPHTTPSendData (JC_HANDLE    vHttpHandle,
                               JC_UINT32    *puiReqId)
{
    return jdi_WPHTTPSendData(vHttpHandle,
                       *puiReqId);
}
...
JC_RETCODE app_WPHTTPSendMoreData (JC_HANDLE    vHttpHandle,
                                   ...
                                   JC_UINT32    uiReqId)
{
    return jdi_WPHTTPSendMoreData(vHttpHandle,
                           *pucBuffer,
                           uiBufferLen,
                           uiReqId);
}
...
{
    return jdi_WPHTTPDataPoll(vHttpHandle,
                       *pstHttpResponse);
}
...
{
    return jdi_WPHTTPCloseConnection(vHttpHandle);
}
...
{
    return jdi_WPHTTPGetTransactionStatus(vHttpHandle,
                                   uiReqId,
                                   *puiSentBytes,
                                   *puiReceivedBytes);
}
...
JC_RETCODE app_WPHTTPAddDigestAuthorization (JC_HANDLE                          vHttpHandle,
        ...
        JC_UINT32                          uiReqId)
{
    return jdi_WPHTTPAddDigestAuthorization(vHttpHandle,
                                    bIsProxy,
                                    *pstDigestAuth,
                                    *pucUrl,
                                    uiReqId);
...
JC_RETCODE app_WPHTTPAddAuthorization (JC_HANDLE        vHttpHandle,
                                       ...
                                       JC_UINT32        uiReqId)
{
    return jdi_WPHTTPAddAuthorization(vHttpHandle,
                               bIsProxy,
                               *pucName,
                               *pucPassword,
                               uiReqId);
...
{
    return jdi_WPHTTPAddBindInfo(vHttpHandle,
                          *pcBindAddress,
                          uhBindPort);
}
...
JC_RETCODE app_WPHTTPSetHostName (JC_HANDLE         vHttpHandle,
                                  ...
                                  JC_UINT32         *puiReqID)
{
    return jdi_WPHTTPSetHostName(vHttpHandle,
                          *pucHostName,
                          *pucAddress,
                          *puiReqID);
}
...
{
    return jdi_WPHTTPSetConnectionState(vHttpHandle,
                            iSocketId,
                            eHttpState,
                            *puiRequestID);
}
...
{
    return jdi_WPHTTPDeInitialize(vHttpHandle);
}
...
JC_RETCODE app_WPHTTPSetTimeOut (JC_HANDLE      vHttpHandle,
                                 ...
                                 JC_UINT32      uiTimeOut)
{
    return jdi_WPHTTPSetTimeOut(vHttpHandle,
                         eTimeOutType,
                         uiTimeOut);
}
...
JC_RETCODE app_WPHTTPSetSocketSelectTimeout (JC_HANDLE              vHttpHandle,
        ...
        JC_UINT32              uiTimeout)
{
    return jdi_WPHTTPSetSocketSelectTimeout(vHttpHandle,
                                     eTimeOutType,
                                     uiTimeout);
}
...
JC_BOOLEAN app_WPHTTPIsHandleForSocket (JC_HANDLE   vHttpHandle,
                                        JC_INT32    iSocket)
{
    return jdi_WPHTTPIsHandleForSocket(vHttpHandle,
                                iSocket);
}
...
{
    return jdi_WPHTTPSetCipherSuites(vHttpHandle,
                              *peCipherSuite,
                              uiCipherSuiteCount);
}
...
{
    return jdi_WPHTTPAddUserCertificate(vHttpHandle,
                                *pstUserCertInfo);
}
...
JC_RETCODE app_WPHTTPAddRootCertificate (JC_HANDLE      vHttpHandle,
        ...
        JC_UINT32      uiCertLen)
{
    return jdi_WPHTTPAddRootCertificate(vHttpHandle,
                                 *pucCert,
                                uiCertLen);
}
...
{
    return jdi_WPHTTPGetNegotiatedCipherSuites(vHttpHandle,
                            *peNegotiatedCipherSuite);
}
...
{
    return jdi_WPHTTPRegisterCertificateCallback(vHttpHandle,
                                        cbCertCallBack);
}
...
JC_RETCODE app_WPHTTPRegisterSecureSessionIndicationCallback (JC_HANDLE                     vHttpHandle,
        ...
        JC_HANDLE                     pvAppArg)
{
    return jdi_WPHTTPRegisterSecureSessionIndicationCallback(cbSecureSessionCallback,
                                                      pvAppArg);
}
#endif
...
{
    return jdi_WPHTTPSocketPoolCleanUp(vHttpHandle,
                                bForceful);
}
...
{
    return jdi_WPHTTPAddStaticHeader(vHttpHandle,
                              *pstMimeHeaders,
                              bIsAccept,
                              eHttpRequestType);
}
...
JC_RETCODE app_WPHTTPAddDynamicHeader (JC_HANDLE        vHttpHandle,
                                       ...
                                       ST_MIME_HEADERS  *pstMimeHeaders)
{
    return jdi_WPHTTPAddDynamicHeader(vHttpHandle,
                               uiRequestId,
                               *pstMimeHeaders);
}
...
JC_RETCODE app_WPHTTPReadData (JC_HANDLE            vHttpHandle,
                               ...
                               JC_UINT32            uiDataLen)
{
    return jdi_WPHTTPReadData(vHttpHandle,
                       iSocketId,
                       *pucReadBuffer,
                       uiDataLen);
}
...
JC_BOOLEAN app_WPHTTPIsDataAvailable (JC_HANDLE     vHttpHandle,
                                      JC_UINT32     uiReqId)
{
    return jdi_WPHTTPIsDataAvailable(vHttpHandle,
                              uiReqId);
}
...
{
    return jdi_WPHTTPSetOffLineStatus(vHttpHandle,
                               bIsOffLine);
}
...
{
    return jdi_WPHTTPSetMaxSockets(vHttpHandle,
                            uiMaxSockets);
}
...
{
    return jdi_WPHTTPGetMaxRequestCount(vHttpHandle,
                                *puiMaxRequests);
}
...
{
    jdi_WPHTTPSetProtocolVersion(vHttpHandle,
                                   eVersion);
}
...
{
    return jdi_WPHTTPParseHeaders(vHttpHandle,*pucHeader,uiHeaderLength,**ppstMimeHeaders);
}
...
{
    return lunch_http_Authorization(http_info1,handler,handler_m);
