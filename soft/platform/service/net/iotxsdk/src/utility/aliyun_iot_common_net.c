...
#include "utility/aliyun_iot_common_net.h"
#include "utility/aliyun_iot_common_log.h"
#include "utility/aliyun_iot_common_hexdump.h"
...
static int read_tcp(Network_t *pNetwork, char *buffer, uint32_t len, uint32_t timeout_ms)
{
    int rc = 0;
    int ret = -1;
    int32_t recvlen = 0;
...
static int write_tcp(Network_t *pNetwork, char *buffer, uint32_t len, uint32_t timeout_ms)
{
    int rc = 0;
    int ret = -1;
    int32_t sendlen = 0;
...
static int disconnect_tcp(Network_t *pNetwork)
{
...
static int connect_tcp(Network_t *pNetwork)
{
    if(NULL == pNetwork)
    {
...
static int read_ssl(Network_t *pNetwork, char *buffer, uint32_t len, uint32_t timeout_ms)
{
    if(NULL == pNetwork)
    {
        ALIOT_LOG_ERROR("network is null");
...
static int write_ssl(Network_t *pNetwork, char *buffer, uint32_t len, uint32_t timeout_ms)
{
    if(NULL == pNetwork)
    {
        ALIOT_LOG_ERROR("network is null");
...
static int disconnect_ssl(Network_t *pNetwork)
{
    if(NULL == pNetwork)
    {
        ALIOT_LOG_ERROR("network is null");
...
static int connect_ssl(Network_t *pNetwork)
{
    if(NULL == pNetwork)
    {
        ALIOT_LOG_ERROR("network is null");
...
int aliyun_iot_net_init(Network_t *pNetwork, char *host, char *port, char *ca_crt)
{
    ...
    pNetwork->handle = -1;
    pNetwork->aliyun_read = aliyun_iot_net_read;
    pNetwork->aliyun_write= aliyun_iot_net_write;
    pNetwork->aliyun_disconnect = aliyun_iot_net_disconnect;
    pNetwork->aliyun_connect = aliyun_iot_net_connect;
