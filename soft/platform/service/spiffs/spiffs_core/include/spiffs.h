...
#define SPIFFS_ERR_WRONG_PARAMETER      -10041
...
/**
 * Rename a file with modify just last one bit
 * @param fs            the file system struct
 * @param old           path of file to rename
 * @param newPath       new path of file, it must be short than old
 */
s32_t SPIFFS_rename_atomic(spiffs *fs, const char *old, const char *newPath);
