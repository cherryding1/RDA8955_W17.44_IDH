...
// ------------------------------------------------------------------------
#define DEFAULT_CALIB_PDN_TX_UP          -90

#define DEFAULT_CALIB_PDN_TX_DN           24
#define DEFAULT_CALIB_PDN_RX_UP         -155
...
#define DEFAULT_CALIB_RX_TX_TIME_OFFSET        (-48)
...
#define DEFAULT_CALIB_PALCUST              {DEFAULT_CALIB_XCV_8955,     \
