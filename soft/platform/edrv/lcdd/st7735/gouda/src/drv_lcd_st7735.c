...
PRIVATE BOOL lcddp_CheckProductId()
{
    ...
    SXS_TRACE(TSTDOUT, "st7735(0x%x): lcd read id is 0x%x ", LCD_ST7735_ID, productId);

    hal_HstSendEvent(0x10007735);
    hal_HstSendEvent(0x1cd001cd);
    hal_HstSendEvent(productId);


    if(productId == LCD_ST7735_ID)
        return TRUE;
    else
        return TRUE;
}
...
{
    static char st7735_id_str[] = "st7735\n";
    return st7735_id_str;
}
// ============================================================================
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL lcdd_st7735_RegInit(LCDD_REG_T *pLcdDrv)
{
