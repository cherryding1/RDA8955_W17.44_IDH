...
PRIVATE VOID lcddp_Init(VOID)
{
    ...
    hal_GoudaSerialMode(HAL_GOUDA_SPI_LINE_3_2_LANE);
    sxr_Sleep(50 MS_WAITING);
...
#ifdef USE_SPI_LCD
    hal_GoudaSerialOpen(HAL_GOUDA_SPI_LINE_3, LCDD_SPI_FREQ_READ, &lcddReadConfig.config, 0);
#else
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_gc9304lane2_RegInit(LCDD_REG_T *pLcdDrv)
{
