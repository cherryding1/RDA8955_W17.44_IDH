...
#define __GC9102_SHEN_LCD_YC__
//#define __GC9102_GKW_YUD_LCD_PARA__
//#define __GC9102_CMO_LCD_PARA__
...
PRIVATE VOID lcddp_Init(VOID)
{
    ...
    LCM_WR_CMD(0xa3);
    LCM_WR_DAT(0x2);    //decrease rate //0x09   10
...
#else
#if defined(__GC9102_CMO_LCD_PARA__)||defined(__GC9102_IVO_LCD_PARA__)||defined(__GC9102_GKW_YUD_LCD_PARA__)||defined(__GC9102_SHEN_LCD_YC__)
...
PRIVATE BOOL lcddp_SetDirDefault(VOID)
{
    ...
    LCM_WR_REG(0x36,0xC0); //Set Scanning Direction
#if 0
#ifdef __LCD_ROTATE_180__
    ...
    LCM_WR_REG(0x36, 0xA0);
#else
#if defined(__GC9102_CMO_LCD_PARA__)||defined(__GC9102_IVO_LCD_PARA__)||defined(__GC9102_GKW_YUD_LCD_PARA__)
...
PRIVATE BOOL lcddp_CheckProductId()
{
    ...
    productId=((UINT16)(productIds[2])<<8 & 0xff00)|((UINT16)productIds[1] & 0x0ff);
#else
#ifdef  LCD_LIANSHANG_GC9102
    productId=((UINT16)(productIds[2])<<8 & 0xff00)|((UINT16)productIds[3] & 0x0ff);
#else
    productId=((UINT16)(productIds[2])<<8 & 0xff00)|((UINT16)productIds[1] & 0x0ff);
#endif
#endif

    hal_HstSendEvent(0x10009102);
    hal_HstSendEvent(0x1cd001cd);

    hal_HstSendEvent(productId);
    SXS_TRACE(TSTDOUT, "gc9102(0x%x): lcd read id is 0x%x ", LCD_gc9102_ID, productId);

    hal_GoudaClose();
    if(productId== LCD_gc9102_ID)
        return TRUE;
    else
        return FALSE;
}
...
{
    static char gc9102_id_str[] = "gc9102\n";
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL lcdd_gc9102_RegInit(LCDD_REG_T *pLcdDrv)
{
