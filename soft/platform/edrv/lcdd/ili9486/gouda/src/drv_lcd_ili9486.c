...
#define LCDD_DISP_Y             480

#define  LCD_ILI9486_ID        0x8694
...
{
    static char ili9486_id_str[] = "ili9486\n";
    return ili9486_id_str;
}
PRIVATE BOOL lcddp_CheckProductId()
{
    ...
    hal_GoudaClose();
    hal_HstSendEvent(0x1cd00000|LCD_ILI9486_ID);
    hal_HstSendEvent(productId);

    SXS_TRACE(TSTDOUT, "ili9486(0x%x): lcd read id is 0x%x ", LCD_ILI9486_ID, productId);

    if(productId == LCD_ILI9486_ID)
        return TRUE;
    else
        return FALSE;
}
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_ili9486_RegInit(LCDD_REG_T *pLcdDrv)
{
