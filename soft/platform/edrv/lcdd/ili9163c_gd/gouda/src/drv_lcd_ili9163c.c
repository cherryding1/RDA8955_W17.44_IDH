...
//zhangqiang 20120410 for lcd 9163c
#ifdef GD_ALL_WRITE
...
//added by zhangqiang. 2012.03.16. for 160X128
...
//#define GD_TFT_9163C_SAITE_YAXIN
...
//by zhangqiang. 2012.01.13
#ifdef GD_ALL_WRITE
#if defined(GD_LCDDP_INIT_FUNC)
    GD_LCDDP_INIT_FUNC;
    return;
#endif
#endif
...
PRIVATE BOOL lcddp_SetDirRotation(VOID)
{
    ...
    //added by zhangqiang. 2012.03.16.for 160X128
    //zhangqiang 20120411
#if defined(GD_LCD_DIRECT_ROTATION)&&defined(GD_ALL_WRITE)
    LCM_WR_CMD_8(0x36); // Memory Access Control
    LCM_WR_DATA_8 (GD_LCD_DIRECT_ROTATION);
#else
#ifdef LCDSIZE_160_128
    main_Write_COM(0x36); //Set Scanning Direction
...
//added by zhangqiang. 2012.03.16.for 160X128
#if defined(GD_LCD_DIRECT_DEFALUT)&&defined(GD_ALL_WRITE)
    main_Write_COM(0x36); // Memory Access Control
    main_Write_DATA (GD_LCD_DIRECT_DEFALUT);
#else
#ifdef LCDSIZE_160_128
    main_Write_COM(0x36); //Set Scanning Direction
    main_Write_DATA(0xB8);  //0xc0
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_ili9163c_gd_RegInit(LCDD_REG_T *pLcdDrv)
{
