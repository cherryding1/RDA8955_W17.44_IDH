...
PRIVATE VOID lcddp_Init(VOID)
{
    ...
    LCM_WR_CMD(0x0000); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0001); LCM_WR_DAT(0x0100);
    LCM_WR_CMD(0x0002); LCM_WR_DAT(0x0100);
    LCM_WR_CMD(0x0003); LCM_WR_DAT(0x10B0);
    LCM_WR_CMD(0x0006); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0008); LCM_WR_DAT(0x0202);
    LCM_WR_CMD(0x0009); LCM_WR_DAT(0x0001);
    LCM_WR_CMD(0x000B); LCM_WR_DAT(0x0010);
    LCM_WR_CMD(0x000C); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x000F); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0007); LCM_WR_DAT(0x0001);
    //------Panel interface control-----------
    LCM_WR_CMD(0x0010); LCM_WR_DAT(0x0014);
    LCM_WR_CMD(0x0011); LCM_WR_DAT(0x0301);
    LCM_WR_CMD(0x0012); LCM_WR_DAT(0x0300);
    LCM_WR_CMD(0x0020); LCM_WR_DAT(0x021E);
    LCM_WR_CMD(0x0021); LCM_WR_DAT(0x0202);
    LCM_WR_CMD(0x0090); LCM_WR_DAT(0x8000);
    LCM_WR_CMD(0x0092); LCM_WR_DAT(0x0000);
    //------------Voltage setting-------------
    LCM_WR_CMD(0x0100); LCM_WR_DAT(0x12b0);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0101); LCM_WR_DAT(0x0147);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0102); LCM_WR_DAT(0x01BE);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0103); LCM_WR_DAT(0x0800);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0107); LCM_WR_DAT(0x0000);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0110); LCM_WR_DAT(0x0001);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0210); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0211); LCM_WR_DAT(0x00ef);
    LCM_WR_CMD(0x0212); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0213); LCM_WR_DAT(0x018f);
    LCM_WR_CMD(0x0200); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0201); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0280); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0281); LCM_WR_DAT(0x0008);
    LCM_WR_CMD(0x0282); LCM_WR_DAT(0x0000);
    sxr_Sleep(10 MS_WAITING);
    //-------------Gamma setting--------------
    LCM_WR_CMD(0x0300); LCM_WR_DAT(0x0101);
    LCM_WR_CMD(0x0301); LCM_WR_DAT(0x092e);
    LCM_WR_CMD(0x0302); LCM_WR_DAT(0x0F2b);
    LCM_WR_CMD(0x0303); LCM_WR_DAT(0x2e0F);
    LCM_WR_CMD(0x0304); LCM_WR_DAT(0x2709);
    LCM_WR_CMD(0x0305); LCM_WR_DAT(0x0101);
    LCM_WR_CMD(0x0306); LCM_WR_DAT(0x1802);
    LCM_WR_CMD(0x0307); LCM_WR_DAT(0x0318);
    LCM_WR_CMD(0x0308); LCM_WR_DAT(0x0607);
    LCM_WR_CMD(0x0309); LCM_WR_DAT(0x0406);
    LCM_WR_CMD(0x030A); LCM_WR_DAT(0x0E07);
    LCM_WR_CMD(0x030B); LCM_WR_DAT(0x0E00);
    LCM_WR_CMD(0x030C); LCM_WR_DAT(0x000E);
    LCM_WR_CMD(0x030D); LCM_WR_DAT(0x070E);
    LCM_WR_CMD(0x030E); LCM_WR_DAT(0x0604);
    LCM_WR_CMD(0x030F); LCM_WR_DAT(0x0706);

    LCM_WR_CMD(0x0400); LCM_WR_DAT(0x3500);
    LCM_WR_CMD(0x0401); LCM_WR_DAT(0x0001);
    LCM_WR_CMD(0x0404); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0500); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0501); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0502); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0503); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0504); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0505); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0600); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0606); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x06F0); LCM_WR_DAT(0x0000);

    LCM_WR_CMD(0x07F0); LCM_WR_DAT(0x5420);
    LCM_WR_CMD(0x07F3); LCM_WR_DAT(0x280F);
    LCM_WR_CMD(0x07F4); LCM_WR_DAT(0x0022);
    LCM_WR_CMD(0x07F5); LCM_WR_DAT(0x0001);
    LCM_WR_CMD(0x07F0); LCM_WR_DAT(0x0000);

    LCM_WR_CMD(0x0007); LCM_WR_DAT(0x0173);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0007); LCM_WR_DAT(0x0061);
    sxr_Sleep(10 MS_WAITING);
    LCM_WR_CMD(0x0007); LCM_WR_DAT(0x0173);
...
PRIVATE LCDD_ERR_T lcddp_Sleep(VOID)
{
    ...
    LCM_WR_CMD(0x07F0); LCM_WR_DAT(0x5420);
    LCM_WR_CMD(0x07DE); LCM_WR_DAT(0x0C00);
    LCM_WR_CMD(0x07F0); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0007); LCM_WR_DAT(0x0000);//Display off
    sxr_Sleep(50 MS_WAITING);                         // Delay 50 ms
    LCM_WR_CMD(0x0100); LCM_WR_DAT(0x0002);//Set to sleep mode
    sxr_Sleep(100 MS_WAITING);                         // Delay 50 ms
...
#else
    LCM_WR_CMD(0x07F0); LCM_WR_DAT(0x5420);
    LCM_WR_CMD(0x07DE); LCM_WR_DAT(0x0400);
    LCM_WR_CMD(0x07F0); LCM_WR_DAT(0x0000);
    LCM_WR_CMD(0x0100); LCM_WR_DAT(0x12B0);//Release state
    sxr_Sleep(50 MS_WAITING);
    LCM_WR_CMD(0x0007); LCM_WR_DAT(0x0173);//Display on
...
PRIVATE VOID lcddp_BlitRoi2Win(CONST HAL_GOUDA_WINDOW_T* pRoi, CONST HAL_GOUDA_WINDOW_T* pActiveWin)
{
    ...
    {
        LCM_WR_CMD(0x0210);  //Set Column Address
        LCM_WR_DAT(pActiveWin->tlPX);
        LCM_WR_CMD(0x0211);  //Set Column Address
        LCM_WR_DAT(pActiveWin->brPX);


        LCM_WR_CMD(0x0212);  //Set Page Address
        LCM_WR_DAT(pActiveWin->tlPY);
        LCM_WR_CMD(0x0213);  //Set Page Address
        LCM_WR_DAT(pActiveWin->brPY);
        LCM_WR_CMD(0x0200);  //Set Column Address
        LCM_WR_DAT(pActiveWin->tlPX);
        LCM_WR_CMD(0x0201);  //Set Page Address
        LCM_WR_DAT(pActiveWin->tlPY);
    }

    LCM_WR_CMD(0x0202);  //Set Page Address
// Send command after which the data we sent
// are recognized as pixels.
...
{
    static char otm4001_id_str[] = "otm4001\n";
    return otm4001_id_str;
}
PRIVATE BOOL lcddp_CheckProductId()
{
    ...
    hal_HstSendEvent(0x4001);
    hal_HstSendEvent(productId);

    hal_GoudaClose();
//  return TRUE;

    SXS_TRACE(TSTDOUT, "ili9327(0x%x): lcd read id is 0x%x ", LCD_OTM4001_ID, productId);

    if(productId == LCD_OTM4001_ID)
        return TRUE;
    else
        return FALSE;
}
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_otm4001_RegInit(LCDD_REG_T *pLcdDrv)
{
