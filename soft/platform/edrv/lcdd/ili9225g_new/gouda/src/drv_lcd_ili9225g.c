...
//************* Start Initial Sequence **********//
    ...
    LCM_WR_REG(0x0014, 0x485C); //515C 4B5C The register setting is suitable for VCI=2.8V
...
PRIVATE VOID lcddp_BlitRoi2Win(CONST HAL_GOUDA_WINDOW_T* pRoi, CONST HAL_GOUDA_WINDOW_T* pActiveWin)
{
    ...
    {
#ifdef LCM_Y_MIRROR_DISPLAY
        LCM_WR_REG(0x0037,LCDD_DISP_X-1-pActiveWin->brPX);//Window Horizontal RAM Address Start
        LCM_WR_REG(0x0036,LCDD_DISP_X-1-pActiveWin->tlPX);//Window Horizontal RAM Address End
        LCM_WR_REG(0x0039,LCDD_DISP_Y-1-pActiveWin->brPY);//Window Vertical RAM Address Start
        LCM_WR_REG(0x0038,LCDD_DISP_Y-1-pActiveWin->tlPY);//Window Vertical RAM Address End
...
#ifdef lcd_line_8_low
    if((productId & 0x00ff) == (LCD_ILI9225G_ID & 0x00ff))
#else
