...
#else
    g_camdI2cBusId =tgt_GetCamdConfig()->i2cBusId;//HAL_I2C_BUS_ID_1;//
...
PRIVATE VOID camerap_SetSpecialEffect(CAM_SPECIALEFFECT_T SpecialEffect)
{
    ...
    switch(SpecialEffect)
    {
        ...
        case CAM_SPE_ANTIQUE    :
            PAS6175_Set_Para_Effect(CAM_EFFECT_ENC_NORMAL);
            break;
...
PRIVATE BOOL camerap_CheckProductId()
{
    ...
    CamConfig.pdnActiveH = TRUE;
    CamConfig.dropFrame = FALSE;
    CamConfig.camClkDiv = 10;//15; // 156MHz/15 = 10.4MHz
    ...
    hal_HstSendEvent(0x123456dd); hal_HstSendEvent(cameraID);
...
{
    static char sp3901_id_str[] = "bf3901\n";
    return sp3901_id_str;
}
...
PUBLIC BOOL camera_bf3901serial_gd_RegInit(CAM_DRV_T  * pCamDrv)
{
