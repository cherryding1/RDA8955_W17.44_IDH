...
{
    {0x12, 0x80, 0xff},  //12[7]=1,将所有寄存器复位为默认值；
    //  {0xff, 0xff, 0x01},

    {0x15, 0x00, 0x01},   //VSYNC LOW
    {0x3e, 0x05, 0x01},
    {0xbb, 0x21, 0x01},
    {0x3a, 0x04, 0x01},
    //====== Analog Setting ======
...
//====== Sensor Control ======
    ...
    {0x8a, 0x1e, 0x01},//50HZ Banding Filter step 0x3c
...
//====== Sensor Control ======
    ...
    {0x8a, 0x29, 0x01},//50HZ Banding Filter step
    // {0x8b, 0xc7, 0x01},//60HZ Banding Filter step
    //switch direction
    {0x1e, 0x39, 0x01},//00:normal  10:IMAGE_V_MIRROR   20:IMAGE_H_MIRROR  30:IMAGE_HV_MIRROR
//===== Drive Capability======
