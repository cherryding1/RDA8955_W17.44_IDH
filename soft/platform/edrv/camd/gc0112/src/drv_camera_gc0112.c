...
PRIVATE void camerap_PowerOn(CAM_SIZE_T CamOutSize, UINT16 IspOutWidth, UINT16 IspOutHeight, CAM_FORMAT_T Format)
{
    ...
    if ((CamOutSize == CAM_NPIX_QVGA) ||(CamOutSize == CAM_NPIX_VGA))
    {
        camOutWidth = 240;
        camOutHeight = 320;
    }
    ...
    // CamConfig.camClkDiv = 11; // 156MHz/11 = 14.2MHz   slow down the mclk for R400
#else
...
PRIVATE void camerap_SetBrightnessL(UINT32 Brightness)
{
    switch(Brightness)
    {
        ...
        case 2:   //-2
            ...
            camerap_WriteOneReg(0xd3, 0x58);
            break;
        case 3: //-1
            camerap_WriteOneReg(0xb5, 0x10);
            camerap_WriteOneReg(0xd3, 0x60);
            break;
        case 4:  //+1
            camerap_WriteOneReg(0xb5, 0x30);
            camerap_WriteOneReg(0xd3, 0x68);
            break;
        case 5:  //+2
...
{
    static char gc0112_id_str[] = "gc0112\n";
    return gc0112_id_str;
}
// ============================================================================
...
PRIVATE BOOL camerap_CheckProductId()
{
    ...
    SXS_TRACE(TSTDOUT,"gc0112(0x%02x): read id is 0x%02x", CAM_GC0112_ID, cameraID);

    if(cameraID == CAM_GC0112_ID)
        return TRUE;
    else
        return FALSE;
}
PUBLIC BOOL camera_gc0112_RegInit(CAM_DRV_T  * pCamDrv)
{
