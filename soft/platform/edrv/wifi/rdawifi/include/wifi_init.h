...
//    {0x22, 0xD3C7},//for ver.c 20111109, txswitch
    ...
    { 0x25, 0x03f9 },//for ver.c 20111109, txswitch //0x03fb
//  { 0x22, 0xD3C7 },//
#ifdef RDA5990_WIFI_USE_DCDC_MODE
//  {0x23, 0xCEE1 },//20111001 higher AVDD voltage to improve EVM
#else
    {0x23, 0x0FA1},
#endif
    { 0x24, 0x80C8 },//freq_osc_in[1:0]00
    { 0x27, 0x4925 },//for ver.c20111109, txswitch
//  { 0x28, 0x00A1 }, //BT_enable { 0x28, 0x80A1 },0x00A1: disable BT, if need uart output should enable BT
    { 0x35, 0x010a }, //WIFI 26M stable TIMIER
...
UINT16 wifi_rf_init_data[][2] =
{
    ...
    {0x27, 0x171D},///mdll*7
    {0x28, 0x031D},///mdll*7
    {0x2A, 0x285D},//et0x2849-8.5p  :yd 0x2861-7pf
...
//set_RF
    ...
    { 0x19, 0x2001 },
    { 0x1C, 0x0934 },
    { 0x1D, 0xCC40 },//for ver.c20111109
//{ 0x1F, 0x01F8 },//for ver.c20111109
    { 0x1F, 0x0300 },//2012 0504  use dr to ctrl 48g div
    { 0x20, 0x06E4 },
    { 0x21, 0x0ACF },//for ver.c20111109,dr dac reset,dr txflt reset
    { 0x22, 0x24DC },
    {0x23, 0x13FF}, // add 2012-12-21
    { 0x24, 0x00FC },
    { 0x26, 0x007D },
    { 0x27, 0x171D },///mdll*7
    { 0x28, 0x031D },///mdll*7
...
//{ 0x0A, 0x0034 },// sw_mode = 2'b10;
//{ 0x0A, 0x002C },//houzhen for pta  sw_mode = 2'b01;
    { 0x0A, 0x0034 },//houzhen for pta  sw_mode = 2'b10;
    { 0x0F, 0x5689 },//
    { 0x30, 0x0241 },
    { 0x09, 0x011E },//delay_swtx_t4=1
    { 0x33, 0x1502 },//liuyanan
    { 0x06, 0x0101 },
    { 0x07, 0x0101 },
    { 0x08, 0x0101 },
