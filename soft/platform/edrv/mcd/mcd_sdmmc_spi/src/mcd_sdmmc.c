...
#define MCD_READ_TIMEOUT_V1       ( 1 SECOND /2)
#define MCD_WRITE_TIMEOUT_V1      ( 1 SECOND/2)

// Timeouts for V2
#define MCD_CMD_TIMEOUT_V2        ( 1 SECOND / 10 )
#define MCD_RESP_TIMEOUT_V2       ( 1 SECOND / 10 )
#define MCD_TRAN_TIMEOUT_V2       ( 1 SECOND / 10 )
#define MCD_READ_TIMEOUT_V2       ( 1 SECOND/5 )
#define MCD_WRITE_TIMEOUT_V2      (1 SECOND/5 )
