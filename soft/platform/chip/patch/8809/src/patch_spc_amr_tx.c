...
extern SPC_AMR_STATE_T g_spcAmrState SPAL_BBSRAM_GLOBAL;

PUBLIC SPP_SPEECH_MODE_T spc_MboxToSppSpeechMode(MBOX_SPEECH_MODE_T encMode);
PROTECTED SPAL_DATA_INTERNAL UINT32 g_spcCtxAmrCfgTxChg=0;


PRIVATE UINT16 SPAL_INTSRAM_PATCH_TEXT patch_spc_RetrieveCodecMode(SPP_AMR_CFG_T *AMR_Cfg)
{
    UINT8 i=0;
    UINT16 CodecModeInd;
    ...
    {
        if((i==AMR_Cfg->nbActiveCodecSet) || (g_spcCtxAmrCfgTxChg == 1))  //not in codec set, force update , TODO:mute.
        {
...
//
// ****************************************************************************
VOID SPAL_INTSRAM_PATCH_TEXT patch_spc_AFSencoding(SPP_AMR_CFG_T AMR_Cfg,
        UINT8 TxCodecMode,
...
//
// ****************************************************************************
VOID SPAL_INTSRAM_PATCH_TEXT patch_spc_AHSencoding(SPP_AMR_CFG_T AMR_Cfg,
        UINT8 TxCodecMode,
        UINT8 CodecModeRequest,
        UINT8 TxFrameType,
        UINT32* InputBuffer,
...
//
// ****************************************************************************
VOID SPAL_INTSRAM_PATCH_TEXT patch_spc_AmrEncode(UINT32 *InputBuffer, UINT16 ChMode, UINT16 CodecModeInd, UINT8 TxFrameType)
{
    ...
    {
        CodecModeInd = patch_spc_RetrieveCodecMode(&g_spcCtx->AMR_Cfg_Tx);
    }
    else
    {
        g_spcCtxAmrCfgTxChg = 0;
    ...
    {
        patch_spc_AFSencoding( g_spcCtx->AMR_Cfg_Tx,
    ...
    {
        patch_spc_AHSencoding( g_spcCtx->AMR_Cfg_Tx,
                               CodecModeInd&AMR_MODE_MASK,
                               g_spcCtx->CodecModeRequest,
                               TxFrameType,
                               InputBuffer,
...
#endif //ENABLE_PATCH_SPC_AMRENCODE
