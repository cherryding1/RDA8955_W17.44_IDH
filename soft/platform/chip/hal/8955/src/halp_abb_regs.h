...
//codec_settings_1_02H
//#define ABB_WRITE_REQ            (1<<31)
//#define ABB_READ_REQ             (1<<30)
...
#define ABB_AU_AD_PD_N_REG         (1<<11)
...
#define ABB_DAC_IBIT(n)          (((n)&0x7)<<9)
#define ABB_DAC_IBIT_MASK        (0x7<<9)
#define ABB_DAC_IBIT_SHIFT       (9)
...
#define ABB_HP_DISCHG_OUT_DIS_DR   (1<<7)
#define ABB_HP_DISCHG_OUT_DIS_REG  (1<<6)
...
#define ABB_HP_MASK_STARTUP        (1<<15)
#define ABB_DVDD_DAC_BIT(n)        (((n)&3)<<13)
#define ABB_RESERVED_ANALOG(n)     (((n)&7)<<10)
//#define ABB_RESERVED(n)          (((n)&0x7F)<<3)
#define ABB_TEST_EN_SPK            (1<<2)
#define ABB_DOUBLE_MODE_EN         (1<<1)
#define ABB_NC_0                   (1<<0)
