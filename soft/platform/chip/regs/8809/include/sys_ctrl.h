...
#define SYS_CTRL_TCU_13M_SEL_26M    (1<<5)
#define SYS_CTRL_TCU_13M_SEL_13M    (0<<5)
...
//Cfg_Clk_Sys
#define SYS_CTRL_SYS_FREQ(n)            (((n)&0xF)<<0)
#define SYS_CTRL_SYS_FREQ_MASK          (0xF<<0)
...
#define SYS_CTRL_CLK_CAM_OUT_SEL_156MHZ (0<<4)
