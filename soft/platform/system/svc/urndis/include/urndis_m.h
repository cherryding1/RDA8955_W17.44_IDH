...
/// @file urndis_m.h
/// @mainpage USB RNDIS service
///
/// This service provides RNDIS service on usb
///
/// This document is composed of:
/// - @ref urndis
///
/// @addtogroup urndis USB RNDIS Service (urndis)
/// @{
///
...
#define pr_warning(format, ...) do {} while (0)
#define pr_err(format, ...) do {} while (0)
#endif
#define rndis_debug		0
#define get_unaligned_le32(p)	 (*p)
...
//porting of linux kernel,end
typedef enum
{
    URNDIS_MSG_RCV_DATA,
    URNDIS_MSG_SEND_INTR
} URNDIS_MSG;
