...
unsigned long last_bitrate;//sheen
int last_flags;//sheen
...
//   return -1;                                                                     //this is omited on 0821 according to cui
    }
...
#else
        header->bitrate=last_bitrate;
        header->flags=last_flags;
        diag_printf("[MP3]WARNING bitrate=0,last bitrate %d flags %d",last_bitrate,last_flags);
        //goto fail;
#endif
    }
    last_bitrate=header->bitrate;//sheen
    last_flags=header->flags;//sheen
