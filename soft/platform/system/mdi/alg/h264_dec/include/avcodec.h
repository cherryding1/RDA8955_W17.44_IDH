...
#define VOC_DO// for debug
#define VOC_DO_MC//for debug
//#endif
//#ifndef SHEEN_VC_DEBUG
//#define CUT_CODE_SHEEN
//#endif
//#define USE_EXT_MB

/*
max vpp_h264_dec_data_set number for collect,
not more than one line MB -1 or be error
sheen
*/
//#define MAX_H264MB_VOC_WORK_NUM 1//18 //not more than one line MB -1 for topborder right or be error,have fixed 20111011,sheen
...
#define FF_RC_STRATEGY_XVID 1
     ...
     * first.
     * - encoding:   , if not then the default based on codec_id will be used.
...
//sheen.add
typedef struct h264handle
{
    AVCodecContext *codec_context;
    AVFrame *frame_picture;
} h264handle;
