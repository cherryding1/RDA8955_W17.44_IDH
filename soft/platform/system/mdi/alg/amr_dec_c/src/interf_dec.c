...
void * Decoder_Interface_init( void )
{
    ...
    /* allocate memory */
    if ( ( s = ( dec_interface_State * ) mmc_MemMalloc( sizeof( dec_interface_State ) ) ) ==
            NULL )
    {
        diag_printf( "Decoder_Interface_init: "
...
{
    //enum Mode mode;   /* AMR mode */ sheen
    enum Mode mode= MR122;   /* AMR mode */
