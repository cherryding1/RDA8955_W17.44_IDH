...
voc_short SPEEX_RESERVR_FOR_ALIGN   ,7,x
...
SPEEX_PRE_EXTEND_MAX_VAL:
    ...
    */
    ...
    VoC_lw16i_set_inc(REG1, SpxPpState_ft, 2);
    VoC_jal(spx_fft);
...
void spx_mult16_32_q15(void)
{
    ...
    */
    ...
    VoC_multf32_rr(ACC0, REG5, REG0, IN_PARALLEL);
...
void spx_mult16_32_p15(void)
{
    ...
    VoC_movreg16(REG5, RL7_LO, DEFAULT); // low in REG4, high in reg5
    //VoC_lw32z(ACC0, DEFAULT);
    VoC_lw32z(ACC1, IN_PARALLEL);
...
void compute_gain_floor(void)
{
    ...
    VoC_mac32_rd(REG5, SPEEX_CONST_236);
    VoC_NOP();
    VoC_movreg32(REG01, ACC0, DEFAULT);
...
COMPUTE_GAIN_FLOOR_IF1:
    VoC_mac32_rd(REG4, SPEEX_CONST_236);
    VoC_NOP();
    VoC_movreg32(REG01, ACC0, DEFAULT);
...
void Rda_speex_preprocess_state_reset(void)
{
    ...
    VoC_lw16i_set_inc(REG0,SpxPpState_gain,2)
    ...
    VoC_lw16i_set_inc(REG0,SpxPpState_post,2)
    ...
    VoC_lw16i_set_inc(REG0,SpxPpState_prior,2)
    ...
    VoC_lw16i_set_inc(REG0,SpxPpState_update_prob,2)
