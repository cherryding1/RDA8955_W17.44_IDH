...
#define KEY_MAP                                                           \
{                                                                         \
    KP_POUND, KP_9, KP_6, KP_3, KP_UP , KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_0, KP_8, KP_5, KP_2, KP_DW, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_STAR,KP_7, KP_4, KP_1, KP_RT , KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToBacklight = {   0, 16, 48, 96, 0, 16, 32, 48},    \
