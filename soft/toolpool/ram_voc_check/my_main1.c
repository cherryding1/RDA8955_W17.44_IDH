...
INT32 * hal_VocGetDmaiPointer(INT32 * vocExternAddr, HAL_VOC_DMA_DIR_T wr1Rd0, HAL_VOC_DMA_TRANSFER_T sngl1brst0, HAL_VOC_DMA_B2S_T b2s)
{
...
void hal_VocWakeuphx_ref()
{
    ...
    addr_tmp = hal_VocGetDmaiPointer((INT32 *)testTable, HAL_VOC_DMA_READ,HAL_VOC_DMA_BURST,HAL_VOC_DMA_B2S_NO);
    hwp_vocCfg->ACC0 = (int)(addr_tmp);

    addr_tmp = hal_VocGetDmaiPointer((INT32 *)test_out,HAL_VOC_DMA_READ,HAL_VOC_DMA_BURST,HAL_VOC_DMA_B2S_NO);
